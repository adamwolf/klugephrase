...
prog_char string_19[] PROGMEM = "Category";
prog_char string_20[] PROGMEM = "MAIN SCREEN TURN ON";
prog_char string_21[] PROGMEM = "*buzz*";
prog_char string_22[] PROGMEM = "USB mode--Reset or CTRL-C to resume normal operations.";
prog_char string_23[] PROGMEM = "feelslikeburning.com/klugephrase";
prog_char string_24[] PROGMEM = "Paused. Press start to resume.";
...
void display_end_of_round(int round_score)
{
  ...
  {
    buffer[startpos+i] = number[i];
  }

  output_string(number, 1, 1);
